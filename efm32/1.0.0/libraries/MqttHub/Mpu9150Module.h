...
class Mpu9150Module : public MqttModule
{
 public:
  virtual void begin(MqttHub &hub, const char* mod, TwoWire *wire, int32_t standbyPin, int32_t frameSyncPin, uint32_t updateDelay);
