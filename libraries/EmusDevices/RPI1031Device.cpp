...
void RPI1031Device::begin(int32_t switchPin1, int32_t switchPin2, int32_t gndPin1, int32_t gndPin2, int32_t gndPin3, uint32_t debounceCount)
{        
    if(gndPin1 > 0)
    {
...
bool RPI1031Device::switchState(uint8_t id)
{
    return (bool)digitalRead(mySwitchPin[id]);
}

bool RPI1031Device::risingEdge(uint8_t id)
{
...
bool RPI1031Device::fallingEdge(uint8_t id)
{
...
Device::ValueStruct RPI1031Device::readValue(int index)
{
...
uint32_t RPI1031Device::numValues()
{
    return 3; 
}
