...
void mpla3115a2Class::begin(const char* mod, TwoWire *_wire, int32_t _enablePin, uint32_t _updateDelay)
{
   if(_enablePin > 0)
  {
...
void mpla3115a2Class::update(void)
{
...
uint8_t mpla3115a2Class::decode(void)
{
...
void mpla3115a2Class::sendMQTTTempData()
{
	COMM.sendMessage((const char*)myModule, "DEG_C", readTemp());	
}
...
{
	COMM.sendMessage((const char*)myModule, "PRESSURE", readPressure());	
}

//Returns the number of meters above sea level
float mpla3115a2Class::readAltitude()
{
...
float mpla3115a2Class::readAltitudeFt()
{
...
float mpla3115a2Class::readPressure()
{
  toggleOneShot(); //Toggle the OST bit causing the sensor to immediately take another reading
...
float mpla3115a2Class::readTemp()
{
  toggleOneShot(); //Toggle the OST bit causing the sensor to immediately take another reading
...
float mpla3115a2Class::readTempF()
{
...
//CTRL_REG1, ALT bit
void mpla3115a2Class::setModeBarometer()
{
...
//CTRL_REG1, ALT bit
void mpla3115a2Class::setModeAltimeter()
{
  byte tempSetting = IIC_Read(CTRL_REG1); //Read current settings
...
void mpla3115a2Class::setModeStandby()
{
  byte tempSetting = IIC_Read(CTRL_REG1); //Read current settings
...
//This is needed so that we can modify the major control registers
void mpla3115a2Class::setModeActive()
{
  byte tempSetting = IIC_Read(CTRL_REG1); //Read current settings
...
//From user jr4284
void mpla3115a2Class::setFIFOMode(byte f_Mode)
{
...
void mpla3115a2Class::setOversampleRate(byte sampleRate)
{
...
void mpla3115a2Class::toggleOneShot(void)
{
  byte tempSetting = IIC_Read(CTRL_REG1); //Read current settings
...
void mpla3115a2Class::enableEventFlags()
{
  IIC_Write(PT_DATA_CFG, 0x07); // Enable all three pressure and temp event flags 
}

// These are the two I2C functions in this sketch.
byte mpla3115a2Class::IIC_Read(byte regAddr)
{
...
void mpla3115a2Class::IIC_Write(byte regAddr, byte value)
{
