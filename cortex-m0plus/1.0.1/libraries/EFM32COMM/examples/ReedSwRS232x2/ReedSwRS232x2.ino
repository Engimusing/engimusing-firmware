...
detectorSwitchClass ReedSwitch0;
detectorSwitchClass ReedSwitch1;
...
void setup()
{
  ...
  ReedSwitch0.begin(6, "EFMZG108/BOARD/REEDSWITCH0", 10);
  ReedSwitch1.begin(7, "EFMZG108/BOARD/REEDSWITCH1", 10);
