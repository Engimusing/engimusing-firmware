...
detectorSwitchClass TiltSwitch1;
detectorSwitchClass TiltSwitch2;
...
void setup()
{
  ...
  TiltSwitch1.begin(11, "EFMZG108/BOARD/TILTSWITCH1", 10);
  TiltSwitch2.begin(12, "EFMZG108/BOARD/TILTSWITCH2", 10);
