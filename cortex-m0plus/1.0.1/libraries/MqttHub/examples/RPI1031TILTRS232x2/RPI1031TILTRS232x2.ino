...
*/
/* Example for how to setup the MQTT client for the RPI 1031 TILT Switch RS232x2 Engimusing board
...
/*
  ...
  {"TOP":"EFMZG108/BOARD/TILTSWITCH1/SWITCH","PLD":"STATUS"}
  {"TOP":"EFMZG108/BOARD/TILTSWITCH2/SWITCH","PLD":"STATUS"}
*/
...
DetectorSwitchModule TiltSwitch1;
DetectorSwitchModule TiltSwitch2;
...
void setup()
{
  ...
  // Tilt sensors two switchs on the board
  TiltSwitch1.begin(HUB, 11, "EFMZG108/BOARD/TILTSWITCH1", 10);
  TiltSwitch2.begin(HUB, 12, "EFMZG108/BOARD/TILTSWITCH2", 10);
